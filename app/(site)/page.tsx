...
export const metadata: Metadata = {
  ...
  description:
    "Explore the web developer portfolio of Dharanish, a full-stack engineer building fast, modern web applications. See what a professional coding portfolio looks like, featuring projects in React, Next.js, and the custom-built React-Zero-UI library.",
